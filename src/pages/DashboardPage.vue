...
<template>
  ...
  <div class="side-nav-open">
    ...
    <RouterLink :to = "{name : 'new-task'}" class="side-bar-item mt-2">
      <i class="bi bi-list-ul side-bar-item-icon"></i>
      <span>New Task</span>
    </RouterLink>
    <RouterLink :to = "{name: 'progress'}" class="side-bar-item mt-2">
      <i class="bi bi-hourglass-split side-bar-item-icon"></i>
      <span>In Progress</span>
    </RouterLink>
    <RouterLink :to = "{name : 'complete'}" class="side-bar-item mt-2">
      <i class="bi bi-check-circle side-bar-item-icon"></i>
      <span>Completed</span>
    </RouterLink>
    <RouterLink :to = "{name:'cancel'}" class="side-bar-item mt-2">
      <i class="bi bi-x-octagon side-bar-item-icon"></i>
      <span>Canceled</span>
    </RouterLink>
    <RouterLink :to = "{name:'trash'}" class="side-bar-item mt-2">
      <i class="bi bi-x-octagon side-bar-item-icon"></i>
      <span>Trashed</span>
    </RouterLink>
  </div>
